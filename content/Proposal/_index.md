...
The Serverless Student Management Platform is designed for educational institutions and small businesses to enhance student data management and analysis capabilities. The platform supports up to 50-100 students, with scalability to 500-1000 students, using web interface combined with APIs for real-time data transmission. The platform leverages AWS Serverless services to provide centralized management, predictive analytics, and cost savings, with limited access for 5-10 teachers/admins through Amazon Cognito.
---
...
**Student Management System**: Web dashboard (CRUD for students, scores, courses), realtime chat, ML ranking. React/Next.js frontend running on Amplify Hosting, using AppSync subscriptions to receive realtime chat messages and ranking updates. Cognito authentication for 5-10 admin/teachers.
