...
| **Amazon API Gateway** | Xử lý và routing yêu cầu API từ frontend đến backend                 | XHỗ trợ REST/HTTP APIs, throttling, caching, và authorizer để tăng hiệu suất và bảo mật.                                        |
